...
class Card extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "updateHeight", () => {
      const top = this.div ? this.div.current.offsetTop : 0;
      this.props.SetCardHeight(document.getElementById("card").clientHeight + this.divRef.current.offsetTop);
    });

    this.divRef = react__WEBPACK_IMPORTED_MODULE_1___default.a.createRef();
  }
...
//# sourceMappingURL=index.js.07a32d05013148fec923.hot-update.js.map